...
const float FEED_TRAVEL_DISTANCE = 3.35; // inches (3.4 for 3 inch squares and 3.25 for 2.65 inch squares)
...
const float CUT_MOTOR_NORMAL_ACCELERATION = 20000; // Acceleration for the cutting pass (steps/sec^2)
...
const unsigned long ROTATION_SERVO_ACTIVE_HOLD_DURATION_MS = 2100;
...
const unsigned long ROTATION_SERVO_SAFETY_DELAY_MS = 2000; // 2 seconds - additional safety delay before returning servo to home 

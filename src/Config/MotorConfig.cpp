...
float CUT_MOTOR_NORMAL_ACCELERATION = 21.3; // inches/sec²  (was 16.0, +33%)
...
float CUT_MOTOR_RETURN_SPEED = 39.93; // inches/sec  (was 30.0, +33%)
float CUT_MOTOR_HOMING_SPEED = 3.46; // inches/sec  (was 2.6, +33%)
...
// Speeds
float FEED_MOTOR_NORMAL_SPEED = 16940;          // was 24200, -30%
float FEED_MOTOR_NORMAL_ACCELERATION = 16940;   // was 24200, -30%
float FEED_MOTOR_RETURN_SPEED = 30800;          // was 44000, -30%
float FEED_MOTOR_RETURN_ACCELERATION = 23100;   // was 33000, -30%
float FEED_MOTOR_HOMING_SPEED = 1650;           // was 1500, +10%

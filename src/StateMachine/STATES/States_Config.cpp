...
const float FEED_TRAVEL_DISTANCE = 3.34; // 3.4 for 3 inch squares and 3.25 for 2.65 inch squares
...
const float ROTATION_CLAMP_EARLY_ACTIVATION_OFFSET_INCHES = 2.7;
...
const float FEED_WOOD_DISTANCE_RETURNING_YES_2X4 = 3.15;
